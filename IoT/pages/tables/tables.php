        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive">
                <table id="data_tabel" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $mysql = mysqli_query($conn, "SELECT * FROM datasensor ORDER BY No DESC");
            ...
            <div class="box">
              ...
              <div class="box-body">
              <p>
                  <center class="btn btn-block btn-default btn-sm" style="font-size: 15px">
                    <?php
                    if (isset($_GET['pesan'])) {
                      if ($_GET['pesan'] == "gagal") {
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $mysql = mysqli_query($conn, "SELECT * FROM login ORDER BY No DESC");
                    while ($r = mysqli_fetch_array($mysql)) { //mengambil data dari MySQL
                    ?>
                      <tr>
                        <td><?php echo $j++ ?></td>
                        ...
                        <td><?php echo $r['No'] ?></td>
                        <td>
                          <a class="btn btn-success btn-sm" href="..\..\pages\tables\Edit.php?User=<?= $r["username"]; ?>"><i class="fa fa-edit"></i></a>
                          <a class="btn btn-danger btn-sm" href="..\..\pages\tables\Hapus.php?User=<?= $r["username"]; ?>"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
