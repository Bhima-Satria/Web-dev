...
<?php
include('../../koneksi.php');
$Data = mysqli_query($conn, "SELECT * FROM datasensor ORDER BY no DESC LIMIT 15");
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/charts/chartjs.php"><i class="fa fa-circle-o"></i> Grafik</a></li>
            </ul>
          </li>
        </ul>
      </section>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <!-- <div class="form-group">
          <label>Pilih Data Pengguna</label>
  ...
  <script>
    $(function() {
      ...
      var suhu1= <?php echo json_encode($Suhu); ?>;
      var jam1= <?php echo json_encode($Jam); ?>.reverse();

      var Kelembabanudara= <?php echo json_encode($KelembabanU); ?>;
      var Kelembabantanah= <?php echo json_encode($KelembabanT); ?>;
      var prediksiuser= <?php echo json_encode($Prediksi); ?>;
