...
if ($_SESSION['level'] != "admin") {
  header("location:../../pages/login/masuk.php?pesan=admin");
}
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
              <div class="box-header">
                ...
                <h3 class="box-title">Info Paket WSN Terbaru</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $mysql = mysqli_query($conn, "SELECT * FROM datawsn ORDER BY Jam DESC LIMIT 17");
                      while ($r = mysqli_fetch_array($mysql)) { //mengambil data dari MySQL
                      ?>
                        <tr>
                        <td><?php echo $r['No'] ?></td>
                          <td><?php echo $r['Id_alat'] ?></td>
                          <td><?php echo $r['Suhu_wsn'] ?></td>
                          <td><?php echo $r['Udara_wsn'] ?></td>
                          <td><?php echo $r['Tanah_wsn'] ?></td>
              ...
              <div class="box box-widget widget-user-2">
                ...
                <div class="box-footer no-padding">
                  <ul class="nav nav-stacked">
                    ...
                    <li><a href="#">Harga Komoditi Sekarang<span class="pull-right badge bg-red"><?php echo $r['HARGA'] ?> K</span></a></li>
                  </ul>
                </div>
              </div>
            <?php } ?>
